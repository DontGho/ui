...
local Library do
    ...
    Library.BindInlineContent = function(self, ContainerItem, TextItem, TrailingItem, LeftOffset, RightOffset)
        ...
        local function Update()
            ...
            local AvailableWidth = MathMax(Container.AbsoluteSize.X - LeftOffset - RightOffset - TrailingWidth - Spacing, 0)
    ...
    local Components = { } do
        ...
        Components.Toggle = function(self, Data)
            ...
            local Items = { } do
                ...
                UpdateInlineLayout = Library:BindInlineContent(Items["Toggle"], Items["Text"], Items["SubElements"], 26, 0)
            end
        ...
        Components.Label = function(self, Data)
            ...
            local Items = { } do
                ...
                UpdateInlineLayout = Library:BindInlineContent(Items["Label"], Items["Text"], Items["SubElements"], 0, 0)
            end
        ...
        function Window:ApplySearch()
            ...
            for _, Value in PageSearchData do
                ...
                if Matches then
                    ...
                    if OldSize then
                        Element:Tween(TweenInfo.new(0.08, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = OldSize})
                    end
                else
